...
/*
Le point d'interrogation représente un paramètre qui sera remplacé par la suite. L'utilisation de requêtes paramétrées est plus sûre que l'intégration des paramètres directement dans la requête.
